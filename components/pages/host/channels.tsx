...
export default function ChannelsPage() {
 ...
 <h1 className="text-lg font-semibold text-black" data-testid="text-channels-title">Manage Channels</h1>
 </div>
 ...
 <Badge
 className={`text-xs no-default-hover-elevate no-default-active-elevate ${getCategoryBadgeClass(isError ? "error" : "active", "status")}`}
 >
