...
export default function NotificationsPage() {
 ...
 <h1 className="text-lg font-semibold text-black" data-testid="text-notifications-title">
 Notifications
 </h1>
 {unreadCount > 0 && (
 <span
 ...
 >
 {clearMutation.isPending ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <><Trash2 className="h-3.5 w-3.5 mr-1.5" />Clear</>}
 </Button>
 )}
 {unreadCount > 0 && (
 <Button
 ...
 const href = getNotificationHref(notif, "host");
