      ...
      <div className="relative h-44">
        ...
        <div className="absolute bottom-3 left-4 right-4">
          <div className="flex items-center gap-2">
            ...
            <Badge
              className={`${getCategoryBadgeClass(listing.status === "ACTIVE" ? "active" : listing.status, "status")} no-default-hover-elevate no-default-active-elevate`}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <Badge className={`text-xs no-default-hover-elevate no-default-active-elevate ${getCategoryBadgeClass(badgeLabel, "status")}`}>
                        {badgeLabel}
                      </Badge>
                      <Button
                        size="sm"
            ...
            <div className="space-y-2">
              {connectedChannels.map((ch) => (
                ...
                >
                  ...
                  <Badge className={`${getCategoryBadgeClass("connected", "status")} text-[10px]`}>Connected</Badge>
                </div>
              ))}
            </div>
            <Button
